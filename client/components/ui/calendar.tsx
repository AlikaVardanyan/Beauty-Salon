  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-muted-foreground rounded-md w-12 font-medium text-xs uppercase tracking-tighter",
        ...
        day: cn(
          ...
          "h-12 w-12 p-0 font-bold rounded-2xl transition-all hover:bg-primary/10 hover:text-primary aria-selected:opacity-100",
        ),
